        ...
        <div class="row">
            <div class="col-sm-12 col-lg-12 mt-4">
                <div class="dataTables_paginate paging_simple_numbers" id="order-listing_paginate">
                    ...
                    <li class='page-item'><a class='page-link' href='blog.php?pageno=" . ($pageno - 1) . "'>Previous</a></li>";
                    for ($i = 1; $i <= $total_pages; $i++) {
                        $pagLink .= "
                       
                        <li class='page-item'><a class='page-link' href='blog.php?pageno=" . $i . "'>" . $i . "</a></li>
                        ";
                    }
                    echo $pagLink . "<li class='page-item'><a class='page-link' href='blog.php?pageno=" . ($pageno + 1) . "'>Next</a></li></ul></nav>";
                    ?>
