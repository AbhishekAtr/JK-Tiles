                   ...
                   <div class="collapse navbar-collapse" id="navbarSupportedContent">
                       <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                           <li class="nav-item dropdown d-none d-xl-inline-block">
                               <a href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle text-white">
                                   <span class="profile-text d-none d-md-inline-flex text-white">Admin</span>
