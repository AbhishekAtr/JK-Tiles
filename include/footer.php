                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="footer-nav-wrap text-dark">
                                ...
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#">Pan Mixer</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#">Tiles Hardeners</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#">Automatic Machine</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#">Paver Making Machine</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="footer-nav-wrap text-dark">
                                ...
                                <ul class="get-in-touch-list">
                                    ...
                                    <li class="d-flex1 align-items-center py-2"><span class="fas fa-phone-alt mr-2"></span> <a href="tel:+91-7827112429">+91-78271 12429</a></li>
                                    <li class="d-flex1 align-items-center py-2"><span class="fa fa-whatsapp mr-2"></span>  <a href="https://api.whatsapp.com/send?phone=7777000006&text=hi...">+91-7777000006</a> </li>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-md-5 col-lg-5">
                    <p class="copyright-text pb-0 mb-0">Copyrights © 2022. All rights reserved.</p>
                </div>
